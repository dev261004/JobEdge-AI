                ...
                <div>
                    <h1 className="text-4xl font-bold text-black sm:text-6xl lg:text-7xl">
                        ...
                        <div className="relative inline-flex">
                            ...
                            <h1 className="relative text-4xl font-bold text-black sm:text-6xl lg:text-7xl">Interview with AI!.</h1>
                        </div>
                    </h1>

                    <p className="mt-8 text-base text-black sm:text-xl">Real-time evaluation, voice feedback, and personalized scoring to help you succeed.</p>
